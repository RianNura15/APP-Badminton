                    ...
                    <tbody>
                        ...
                        @foreach($data as $dt)
                            <tr>
                                ...
                                <td>{{$dt->kegiatan}}</td>
                                <td align="center">
                                    <a href="{{route('jam',$dt->id_lapangan)}}" class="btn btn-sm btn-primary">
                                    ...
                                    <a href="lapangan/delete/{{$dt->id_lapangan}}" onclick="return confirm('Yakin hapus data lapangan {{$dt->nama_lap}}?')" class="btn btn-sm btn-danger">
                            ...
                            <?php $no++ ?>
                            <div class="modal fade" id="edit{{$dt->id_lapangan}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">Menambah Data Sarana</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="form=group">
                                <label>Nama Sarana</label>
                                <input type="text" required="" class="form-control" name="nama_lap" autofocus>
                            </div>  
                        </div>
                        <div class="col-6">
                            <div class="form-group">
