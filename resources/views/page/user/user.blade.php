                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            @if($dt->status_user=="Aktif")
                            <a href="{{route('status_user',$dt->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('Yakin Akun {{$dt->name}} akan di Nonaktifkan?')"><i class="dripicons dripicons-lock"></i></a>
                            @endif
                            @if($dt->status_user!=="Aktif")
                            <a href="{{route('status_user',$dt->id)}}" class="btn btn-sm btn-success" onclick="return confirm('Yakin Mengaktifkan Akun?')"><i class="dripicons dripicons-lock-open"></i></a>
                            @endif
