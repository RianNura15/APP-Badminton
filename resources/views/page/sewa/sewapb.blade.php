                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        @foreach($data as $dt)
                            ...
                            <div class="modal fade" id="cek{{$dt->id_sewa}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form class="form form-vertical" method="GET" action="{{route('konfirmasipb',$dt->id_sewa)}}">
                                            ...
                                            <div class="modal-footer">
                                                <button class="btn btn-sm btn-outline-primary form-control rounded-pill mt-4" style="margin-top: -50px;" onclick="return confirm('Yakin Akan Mengkonfirmasi?')"> 
                            ...
                            <div class="modal fade" id="batal{{$dt->id_sewa}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">Batalkan</h5>
                                            <button type="button" class="close" data-bs-dismiss="modal"
                                            aria-label="Close">
                                                <i data-feather="x"></i>
                                            </button>
                                        ...
                                        <form class="form form-vertical" method="GET" action="{{route('batalkanpb',$dt->id_sewa)}}">
                                            ...
                                            <div class="modal-footer">
                                                <button class="btn btn-sm btn-outline-danger form-control rounded-pill mt-4" style="margin-top: -50px;" onclick="return confirm('Yakin Akan Dibatalkan?')"> 
                                                    <i class="icon dripicons-document-edit"></i>
                                                Batalkan
                                                </button>
                                            </div>
