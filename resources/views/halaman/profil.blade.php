                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @endif
                            @if($datenow >= $paymentDueDate && $dt->status_perpanjang == 1)
                            ...
                            @endif
                            @if($dt->opsi_bayar == 'Online' && $dt->status_bayar == 'Perpanjangan Belum di Bayar' && $dt->pengajuan_member == '1' && $dt->jml_jadimember != NULL)
                                <button type="button" class="btn rounded-pill btn-md btn-success block pay-button" style="float: right; margin-right: 5px;" data-snap-token="{{$dt->snap_token}}" data-id="{{$dt->id_bayar}}">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    @foreach($data as $cst)
                                        ...
                                        @if($cst->member == 1 && $cst->jangka_waktu != NULL)
                                            <tr>
                                        ...
                                        @if($cst->pengajuan_member == 1 && $cst->member == 0)
                                            <tr>
                                                ...
                                                @elseif($cst->status_bayar == 'Terbayar' && $cst->jml_jadimember != NULL)
                                                <td><span class="badge bg-success">Perpanjangan Terbayar</span></td>
                                                @else
                                                ...
                                                <div class="modal-content" style="border-bottom:1px solid blue;">
                                                    ...
                                                    <form method="post" action="{{route('perpanjangmember')}}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-primary ml-1" onclick="return confirm('Yakin Memperpanjang Member?')">
                                                                <i class="bx bx-check d-block d-sm-none"></i>
